...
<Col xl={2}> 
<Button variant="light" type="submit" style={{width:"150px", height:"45px", backgroundColor:"#FF7B59", border:"none", marginTop:"23px"}} onClick={triggerconfirmSignUp}>Confirm Sign Up</Button>
</Col> 
</Row>
